...
(function() {
  ...
  window.PGBubblesChart = (function(_super) {
    ...
    PGBubblesChart.prototype.minRadius = 5;
    ...
    function PGBubblesChart(container, margin, dataset, axes, limit) {
      ...
      this.data = dataset;
      this.rScale = d3.scale.sqrt().range([this.minRadius, this.maxRadius]);
    ...
    PGBubblesChart.prototype.chart = function(selection) {
      ...
      return selection.each(function(rawData) {
        ...
        svg.attr("width", that.width + that.margin.left + that.margin.right).attr("height", that.height + that.margin.top + that.margin.bottom).on('mousedown', function() {
